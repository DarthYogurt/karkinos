...
exports.JS_RESERVED = [ "break", "case", "catch", "continue", "debugger", "default", "delete", "do", "else", "finally", "for", "function", "if", "in", "instanceof", "new", "return", "switch", "this", "throw", "try", "typeof", "var", "void", "while", "with" ];

exports.JS_RESERVED_FUTURE = [ "class", "enum", "export", "extends", "import", "super", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield" ];

exports.JS_RESERVED_ALL = _.union(exports.JS_RESERVED, exports.JS_RESERVED_FUTURE);

var NS_ALLOY = "Alloy", NS_ALLOY_ABSTRACT = "Alloy.Abstract", NS_TI_ANDROID = "Ti.Android", NS_TI_MAP = "Ti.Map", NS_TI_MEDIA = "Ti.Media", NS_TI_UI_IOS = "Ti.UI.iOS", NS_TI_UI_IPAD = "Ti.UI.iPad", NS_TI_UI_IPHONE = "Ti.UI.iPhone", NS_TI_UI_MOBILEWEB = "Ti.UI.MobileWeb";
